...
<a href="{{route('author.post.index')}}" class="btn btn-danger m-t-15 waves-effect"><i class="material-icons">settings_backup_restore</i> 
               <span>Back</span> </a>
           ...
           <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                        <img class="img-responsive thumbnail" src="{{ url('storage/app/public/post/'.$post->image) }}" >
                        </div>
                    </div>
                </div>
            </div>
